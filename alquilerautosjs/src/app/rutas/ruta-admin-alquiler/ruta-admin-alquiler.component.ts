...
@Component({
  selector: 'app-ruta-admin-alquiler',
  templateUrl: './ruta-admin-alquiler.component.html',
  styleUrls: ['./ruta-admin-alquiler.component.css']
})
export class RutaAdminAlquilerComponent implements OnInit {
